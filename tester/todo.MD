...
- [ ] Crie uma função firt_node que retorne o 1 nó da lista se ele existir ou null se não existir.
- [ ] Crie uma função third_node que retorne o 3 nó da lista se ele existir ou null se não existir.
...
- [ ] Escreva uma função lst_sum que percorre a lista e retorna a soma de todos os elementos.
