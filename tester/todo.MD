...
- [ ] Dada uma lista encadeada, escreva uma função para inverter todos os primeiros k nós (onde k é dado como parâmetro). https://redquark.org/leetcode/0025-reverse-nodes-in-k-group/
